            ...
            <main className="flex-grow container mx-auto px-4 sm:px-4 lg:px-0 py-12">
              <div className="max-w-7xl mx-auto">
                <div className="flex justify-center items-center">
                  ...
                  <h1 className="text-3xl md:text-5xl font-bold text-yellowgreen-400 mb-1 text-center uppercase">
                    AI-Powered Debates
                  </h1>
                ...
                <div className="max-w-7xl mx-auto mb-4">
                  ...
                  <div className="flex flex-col gap-2 sm:hidden">
                    ...
                    <button
                      ...
                      className="w-full px-6 py-2.5 bg-yellowgreen-400 hover:bg-yellowgreen-100 text-gray-900 font-medium rounded-lg flex items-center justify-center gap-2 transition-colors border border-yellowgreen-400 lowercase"
                    >
                      <SparkleIcon />
                      Launch New Debate
                    </button>
                  ...
                  <div className="hidden sm:grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <button
                      onClick={() => setIsModalOpen(true)}
                      className="px-6 py-2.5 bg-yellowgreen-400 hover:bg-yellowgreen-100 text-gray-900 font-medium rounded-lg flex items-center justify-center gap-2 transition-colors border border-yellowgreen-400 lowercase"
                    >
                      <SparkleIcon />
                      Launch New Debate
                    </button>
